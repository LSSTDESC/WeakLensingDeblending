...
Run i-band calculation for LSST with a small field::
	...
	./simulate.py --catalog-name OneDegSq.dat --ra-center 0.5 --dec-center 0.0 --image-width 512 --image-height 512 --survey-name LSST --filter-band i  --no-agn--output demo --verbose --verbose-build --verbose-render
