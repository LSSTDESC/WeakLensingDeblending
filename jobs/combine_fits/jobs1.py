...
def main():
    ...
    parser = argparse.ArgumentParser(description=('Combines different fits (16) into'
                                                  'single table and image with noise'),
                                 formatter_class=(
    ...
    job_number = int(argv[1])
    noise_seed = int(argv[2])  #when adding noise to the image. 
