...
>>>>>>> 20af9f87af1c3bda1783c876ad9940fe3d1e27dc
    def __init__(self,survey,table,stamps,bounds,num_slices):
        ...
        if len(self.stamps) > 0:
            if self.num_slices not in (1,len(self.slice_labels),len(self.slice_labels_star)):
...
>>>>>>> 20af9f87af1c3bda1783c876ad9940fe3d1e27dc
    def get_stamp(self,index,datacube_index=0):
        ...
        Args:
            index(int): Index of the requested object in our results. Use
                meth:`find_galaxy` to get the index for an identifier.
            datacube_index(int): Which slice of the datacube to return.

        Returns:
            galsim.ImageView: A GalSim image for the requested object. Note that the
...
>>>>>>> 20af9f87af1c3bda1783c876ad9940fe3d1e27dc
    def get_fisher_images(self,index1,index2,background):
        ...
        if (npar != len(self.slice_labels) and npar !=len(self.slice_labels_star)):
<<<<<<< HEAD
...
>>>>>>> 20af9f87af1c3bda1783c876ad9940fe3d1e27dc
        ...
        if num_slices != len(results.slice_labels) and num_slices != len(results.slice_labels_star):
